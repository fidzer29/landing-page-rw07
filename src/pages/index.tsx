...
import Deny from "@/assets/A Deny.png";
...
const Index = () => {
  ...
  const events = [
    {
      src: [kegiatan1],
      title: "Pendataan Verval Warga",
      description:
        "Kegiatan ini dilakukan untuk memastikan kebenaran data warga",
    },
    {
      src: [kegiatan2],
      title: "Kerja Bakti",
      description:
        "Kegiatan ini dilakukan untuk secara rutin untuk menjadi pembiasaan bagi warga menjaga kebersihan lingkungan",
    },
    {
      src: [kegiatan3],
      title: "Peduli Warga 24 Jam",
      description:
        "Program ini bertujuan untuk menimbulkan rasa empati dan kebersasan terhadap sesama warga RW 07",
    },
    {
      src: [kegiatan4],
      title: "Hari Raya Idul Adha",
      description: "Program rutin untuk dilakukan setahun sekali",
    },
    {
      src: [kegiatan5],
      title: "Zumba Rukun Warga 07",
      description:
        "Program kegiatan ini bertujuan untuk membangun kebiasaan yang bagus bagi warga RW 07",
    },
    {
      src: [kegiatan6],
      title: "Keamanan 24 Jam",
      description:
        "Program ini bertujuan untuk menjaga lingkungan tetap aman dan nyaman bagi warga RW 07",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
        ...
        {/* Overlay Gradients */}
        <div className="absolute inset-0 bg-gradient-to-br from-transparent via-secondary/20 to-accent/30 z-[6] pointer-events-none"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(255,255,255,0.1),transparent_50%)] z-[6] pointer-events-none"></div>
        <div className="absolute top-20 left-10 w-72 h-72 bg-accent/20 rounded-full blur-3xl animate-float z-[6] pointer-events-none"></div>
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-secondary/20 rounded-full blur-3xl animate-float z-[6] pointer-events-none"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center animate-slide-up">
            ...
            <p className="text-xl md:text-2xl text-white/95 mb-10 max-w-3xl mx-auto font-light leading-relaxed">
              Bersama menciptakan lingkungan yang harmonis, aman, dan sejahtera
              untuk semua warga
            </p>
            <div className="flex gap-6 justify-center flex-wrap">
              <Button
                size="lg"
                className="text-lg px-10 py-7 bg-white text-primary hover:bg-white/90 shadow-2xl hover:shadow-white/20 transition-all hover:scale-105 font-semibold"
              >
                Bergabung Sekarang
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="text-lg px-10 py-7 glass-effect border-2 border-white/40 text-white hover:bg-white/20 shadow-2xl font-semibold"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Mengenal lebih dekat tentang Rukun Warga 07 dan komitmen kami
            ...
            <Card className="flex flex-col justify-between h-full p-10 hover:shadow-2xl transition-all hover:scale-105 border-2 border-primary/20 bg-white/80 backdrop-blur">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">
                  RW 07 merupakan komunitas warga yang peduli dan aktif dalam
                  membangun lingkungan yang lebih baik. Kami berkomitmen untuk
                  menciptakan suasana yang harmonis, aman, dan nyaman bagi
                  seluruh warga.
                </p>
              </div>
            </Card>
            ...
            <Card className="flex flex-col justify-between h-full p-10 hover:shadow-2xl transition-all hover:scale-105 border-0 bg-gradient-to-br from-primary via-secondary to-accent">
              <div>
                ...
                <p className="text-white/95 leading-relaxed text-lg">
                  Meliputi 4 RT dengan total lebih dari 376 Kepala Keluarga yang
                  tersebar di area seluas 25 hektar. Lokasi strategis dengan
      ...
      <section
        id="visi-misi"
        className="py-24 relative overflow-hidden bg-gradient-to-br from-primary via-secondary to-accent"
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-white/95 text-lg max-w-2xl mx-auto font-light">
              Landasan dan arah perjuangan kami untuk masa depan yang lebih
              cerah
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-10 glass-effect border-2 border-white/30 hover:shadow-2xl transition-all hover:scale-105 bg-white/10 backdrop-blur-xl">
              ...
              <p className="text-white/95 leading-relaxed text-lg font-light">
                Mewujudkan RW 07 sebagai lingkungan yang asri, aman, harmonis,
                dan sejahtera dengan warga yang peduli dan aktif dalam
                pembangunan.
              </p>
            </Card>
            ...
            <Card className="p-10 glass-effect border-2 border-white/30 hover:shadow-2xl transition-all hover:scale-105 bg-white/10 backdrop-blur-xl">
              ...
              <ul className="text-white/95 space-y-4">
                <li className="flex items-start gap-4 group">
                  <span className="text-white text-2xl bg-white/20 backdrop-blur rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                    ✓
                  </span>
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            <CardContent className="p-8 text-center relative z-10">
              <img
                src={Deny}
                className="w-40 h-40 object-contain bg-white rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg"
              />
              <p className="text-sm text-muted-foreground mb-2 uppercase tracking-wider">
                Ketua RW 07
              </p>
              <p className="text-2xl font-bold">Deny Romansyah</p>
            </CardContent>
            ...
            {[
              {
                ...
                description:
                  "Kegiatan gotong royong membersihkan lingkungan setiap minggu untuk menjaga kebersihan dan keindahan RW",
                color: "primary",
              },
              {
                title: "Posyandu Balita",
                description:
                  "Pelayanan kesehatan untuk ibu dan anak dengan jadwal rutin setiap bulan",
                color: "accent",
              },
              {
                title: "Ronda Malam",
                description:
                  "Sistem keamanan lingkungan dengan jadwal ronda bergantian untuk menjaga keamanan warga",
                color: "accent",
              },
              {
                title: "Peringatan Hari Besar",
                description:
                  "Perayaan hari besar nasional dan keagamaan bersama seluruh warga RW",
                color: "primary",
              },
              {
                title: "Arisan & PKK",
                description:
                  "Kegiatan pemberdayaan ibu-ibu PKK dan arisan warga untuk mempererat silaturahmi",
                color: "accent",
              },
              {
                title: "Olahraga Bersama",
                description:
                  "Kegiatan olahraga rutin seperti senam pagi dan jalan sehat untuk kesehatan warga",
                color: "accent",
              },
            ].map((program, index) => (
              <Card
                key={index}
                className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden group"
              >
                <div
                  className={`absolute inset-0 gradient-${program.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300`}
                ></div>
                <CardContent className="p-8 relative z-10">
                  <div
                    className={`w-14 h-14 gradient-${program.color} rounded-xl flex items-center justify-center mb-6 shadow-lg`}
                  >
            ...
            <CardContent className="p-12 relative z-10">
              <div className="grid md:grid-cols-2 gap-12">
                  ...
                  {[
                    {
                      ...
                      content: (
                        <>
                          Jl. Soekarno Hatta Gg.H.Hasan II, RT 01/RW 07
                          <br />
                ...
                <div className="bg-muted/30 rounded-2xl p-8">
                  ...
                  <a
                    href="https://wa.me/6281339458179"
                    target="_blank"
